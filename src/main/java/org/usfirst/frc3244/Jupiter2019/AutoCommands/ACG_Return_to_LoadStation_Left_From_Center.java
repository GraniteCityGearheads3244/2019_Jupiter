...
public class ACG_Return_to_LoadStation_Left_From_Center extends CommandGroup {
  /**
   * Add your docs here.
   */
  public ACG_Return_to_LoadStation_Left_From_Center() {
    ...
    addSequential(new Drive_Turn_To_Setpoint(180),2);
    addSequential(new Drive_For_Distance_PID(.25, 20, 180));
  }
}
