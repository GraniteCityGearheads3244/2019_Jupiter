...
public class Auto_21_Drive_Right_Cargo_Pos1 extends CommandGroup {
  ...
  public Auto_21_Drive_Right_Cargo_Pos1() {
    ...
    addSequential(new Drive_For_Distance(0.25, 0.0, 25, 0.0));
    addSequential(new Drive_Turn_To_Setpoint(-90),1);
    addSequential(new Drive_For_Distance(0.25, 0.0, 10, -90));
    addSequential(new Drive_Turn_To_Setpoint(0.0),1);
    addSequential(new Drive_For_Distance(0.25, 0.0, 10, 0.0));
    addSequential(new Drive_Turn_To_Setpoint(90),1);
    addSequential(new Drive_For_Distance(0.25, 0.0, 10, 90.0));
