...
public class OI {
    ...
    public JoystickButton grabHatchButton;
    public JoystickButton deliverHatchButton;

    public JoystickButton armFullUp_Button;
    public JoystickButton hatchPick_Place_Low_Button;
    public JoystickButton armFullDown_Button;
   
    public JoystickAxisButton cargoIntake_BTN;
    public JoystickAxisButton cargoEject_BTN;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
      joystickButton7 = new JoystickButton(xBox_Driver, 7);
      joystickButton7.whenPressed(new Elevator_To_Setpoint(500));

      joystickButton8 = new JoystickButton(xBox_Driver, 8);
      joystickButton8.whenPressed(new Elevator_To_Setpoint(10));
      
        grabHatchButton = new JoystickButton(xBox_Driver, 5);
        grabHatchButton.whenPressed(new CG_HatchGrabSeqStart());
        grabHatchButton.whenReleased(new CG_HatchGrabSeqComplete());
        
        deliverHatchButton = new JoystickButton(xBox_Driver, 6);
        deliverHatchButton.whenPressed(new CG_HatchDeliver());
        deliverHatchButton.whenReleased(new CG_HatchDeliverSeqComplete());
        
        armFullUp_Button = new JoystickButton(xBox_Driver, 1);
        armFullUp_Button.whileHeld(new Arm_To_Setpoint(Robot.arnm.UP));
        hatchPick_Place_Low_Button = new JoystickButton(xBox_Driver, 2);
        hatchPick_Place_Low_Button.whileHeld(new Arm_To_Setpoint(Robot.arnm.HATCH_PICK));
        armFullDown_Button = new JoystickButton(xBox_Driver, 4);
        armFullDown_Button.whileHeld(new Arm_To_Setpoint(Robot.arnm.DOWN));

        cargoIntake_BTN = new JoystickAxisButton(xBox_Driver, 3);
        cargoIntake_BTN.whileHeld(new Cargo_Intake(1));

        cargoEject_BTN = new JoystickAxisButton(xBox_Driver, 2);
        cargoEject_BTN.whileHeld(new Cargo_Eject(-1));

        joystickButton4 = new JoystickButton(xBox_CoDriver, 4);
        joystickButton4.whileHeld(new Extend());
        joystickButton3 = new JoystickButton(xBox_CoDriver, 3);
        joystickButton3.whileHeld(new Grip());
        joystickButton2 = new JoystickButton(xBox_CoDriver, 2);
        joystickButton2.whileHeld(new Ungrip());
        joystickButton1 = new JoystickButton(xBox_CoDriver, 1);
        joystickButton1.whileHeld(new Retract());
