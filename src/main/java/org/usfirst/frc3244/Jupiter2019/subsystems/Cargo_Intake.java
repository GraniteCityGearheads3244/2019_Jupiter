...
public class Cargo_Intake extends Subsystem {
    ...
    private VictorSP motor_Cargo_Intake;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    public Cargo_Intake() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        motor_Cargo_Intake = new VictorSP(2);
        addChild("Motor_Cargo_Intake",motor_Cargo_Intake);
        motor_Cargo_Intake.setInverted(false);
